...
:gs-consuming-rest-jquery: https://spring.io/guides/gs/rest-service/gs/consuming-rest-jquery/
:gs-spring-boot: https://spring.io/guides/gs/rest-service/gs/spring-boot/
...
data, as the following listing (from
  `complete/src/main/java/com/example/restservicecors/Greeting.java`) shows:
...
`complete/src/main/java/com/example/restservicecors/GreetingController.java`) handles `GET`
...
listing (from `complete/src/main/java/com/example/restservicecors/GreetingController.java`) shows:
...
`complete/src/main/java/com/example/restservicecors/GreetingController.java`) shows the
...
The following listing (from
`complete/src/main/java/com/example/restservicecors/RestServiceCorsApplication.java`) shows how to
